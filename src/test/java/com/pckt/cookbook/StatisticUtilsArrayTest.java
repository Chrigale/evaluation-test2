...
public class StatisticUtilsArrayTest {
    ...
    /**
     * This method is used for testing the getMax() method of the StatisticUtilsArray class.
     **/
    @ParameterizedTest
    @MethodSource("testMaxProvider")
    public void testMax(double[] input, double expected) { assertEquals(expected, calculator.getMax(input)); }
    ...
    /**
     * This method is used for testing the getMin() method of the StatisticUtilsArray class.
     **/
    @ParameterizedTest
    @MethodSource("testMinProvider")
    public void testMin(double[] input, double expected) { assertEquals(expected, calculator.getMin(input)); }
    ...
    /**
     * This method is used for testing the getMean() method of the StatisticUtilsArray class.
     **/
    @ParameterizedTest
    @MethodSource("testMeanProvider")
    public void testMean(double[] input, double expected) { assertEquals(expected, calculator.getMean(input)); }
    ...
    /**
     * This method is used for testing the getMedian() method of the StatisticUtilsArray class.
     **/
    @ParameterizedTest
    @MethodSource("testMedianProvider")
    public void testMedian(double[] input, double expected) { assertEquals(expected, calculator.getMedian(input)); }
    ...
    /**
     * This method is used for testing the getStandardDeviation() method of the StatisticUtilsArray class.
     **/
    @ParameterizedTest
    ...
    /**
     * This method is used for testing the getMax() , getMin() , getMean() , getMedian() , getStandardDeviation() methods of StatisticUtilsArray class
    ...
    /**
     * This method is used for testing the getMean() and getStandardDeviation() methods of StatisticUtilsArray class
